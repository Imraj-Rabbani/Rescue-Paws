...
export default function ProductNavbar() {
  ...
  return (
    <>
      {/* Promo Bar */}
      <div className="bg-[Cornsilk] text-black text-center py-2 px-4 text-sm text-center">
        <p>✨ Premium pet products with 10% donated to animal rescues ✨</p>
      </div>
      ...
      <nav className="bg-white shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4">
          ...
          <div className="hidden md:flex space-x-6 py-3 border-t border-gray-100">
            ...
            <Link to="/products/food" className="text-gray-600 hover:text-purple-600 flex items-center">
              <span className="mr-1">🍗</span> Food & Treats
            </Link>
            <Link to="/products/tech" className="text-gray-600 hover:text-purple-600 flex items-center">
              <span className="mr-1">📱</span> Smart Tech
            </Link>
            <Link to="/products/toys" className="text-gray-600 hover:text-purple-600 flex items-center">
              <span className="mr-1">🎾</span> Toys
            </Link>
            <Link to="/products/health" className="text-gray-600 hover:text-purple-600 flex items-center">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-3 border-t border-gray-100">
              <div className="flex flex-col space-y-3">
                <Link to="/products" className="text-purple-600 font-medium">All Products</Link>
                <Link to="/products/food" className="text-gray-600">Food & Treats</Link>
                <Link to="/products/tech" className="text-gray-600">Smart Tech</Link>
                <Link to="/products/toys" className="text-gray-600">Toys</Link>
                <Link to="/products/health" className="text-gray-600">Health</Link>
                <Link to="/account" className="text-gray-600">My Account</Link>
              </div>
            </div>
          )}
        </div>
