...
export default function ProductNavbar() {
  ...
  const { cart, isLoggedIn, userData, backendUrl, resetCart } =
            ...
            <div className="md:hidden py-3 border-t border-gray-100">
              <div className="flex flex-col space-y-3">
                ...
                <Link
                  to="/products/category/food"
                  className={`${
                    location.pathname.includes("/category/food")
                      ? "text-purple-600 font-medium"
                      : "text-gray-600"
                  }`}
                >
                ...
                <Link
                  to="/products/category/tech"
                  className={`${
                    location.pathname.includes("/category/tech")
                      ? "text-purple-600 font-medium"
                      : "text-gray-600"
                  }`}
                >
                ...
                <Link
                  to="/products/category/toys"
                  className={`${
                    location.pathname.includes("/category/toys")
                      ? "text-purple-600 font-medium"
                      : "text-gray-600"
                  }`}
                >
                ...
                <Link
                  to="/products/category/health"
                  className={`${
                    location.pathname.includes("/category/health")
                      ? "text-purple-600 font-medium"
                      : "text-gray-600"
                  }`}
                >
